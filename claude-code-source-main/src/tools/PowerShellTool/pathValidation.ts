      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, OH-code may only access files in the allowed working directories for this session: ${dirListStr}.`
        ...
        for (const redir of cmd.redirections) {
          ...
          if (!allowed) {
            ...
            const message =
              ...
              decisionReason?.type === 'safetyCheck'
                ? decisionReason.reason
                : `Output redirection to '${resolvedPath}' was blocked. For security, OH-code may only write to files in the allowed working directories for this session: ${dirListStr}.`
