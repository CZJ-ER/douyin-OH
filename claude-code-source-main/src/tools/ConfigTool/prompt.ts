...
export function generatePrompt(): string {
  ...
  return `Get or set OH-code configuration settings.

  View or change OH-code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
